...
function Myproblemlayout({name,question, Animation: Animate, steps , Algorithm= "Brute Force", Timecomplex, Spacecomplex}) {
    ...
    <>
      <div id="probdis">
        ...
        <div id="probans">
          ...
          <div className="box2 b2">
            Output of codeEditor
          </div>
          ...
          <div className="box3">
            ...
            <div>
              <h3>Time: {Timecomplex}</h3>
            </div>
            <div>
              <h3>space: {Spacecomplex}</h3>
            </div>
