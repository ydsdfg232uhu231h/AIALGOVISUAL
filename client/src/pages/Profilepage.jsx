              ...
              <div id="aafps-prof-titles">
                <div id="aafps-prof-name-row">
                  ...
                  <span id="aafps-prof-goal-tag">
                    {user?.targetGoal || "Dynamic Programming & Graphs"}
                  </span>
                </div>
                ...
                <p id="aafps-prof-bio">
                  {user?.bio || "Algorithm problem solver mastering concepts visually."}
                </p>
              </div>
            </div>
